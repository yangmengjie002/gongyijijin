...
>>>>>>> 712c1a0a5b929633c3629d3b36326b3b23e03260
		...
		<form action="emp_selectEmp.action">
			<div class="col-xs-5">
				...
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon3">用户ID</span> <input
						name="id" type="text" class="form-control" id="basic-url"
			...
			<div class="col-xs-5">
				...
				<div class="input-group">
					<span class="input-group-addon add-on" id="basic-addon1">入职日期<i
						class="icon-th"></i>
					</span> <input name="hireDate" type="text"
			...
			<div class="col-xs-5">
				...
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon3">用户ID</span> <input
						name="username" type="text" class="form-control" id="basic-url"
						aria-describedby="basic-addon3">
				</div>
			</div>
			<div class="col-xs-5">
				...
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon3">状态</span> <input
						name="statusId" type="text" class="form-control" id="basic-url"
						aria-describedby="basic-addon3">
				</div>
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="col-xs-10"></div>
				<button type="submit" class="btn btn-primary btn">搜索</button>
		</form>
							...
							<div class="row">
								...
								<div class="col-md-9">
									<table class="table">
										...
										<tr>
											<td>离职日期</td>
											<td><input type="text" name="em.emp_leave_date" />
											</td>
										</tr>
										<tr>
											<td>家庭住址</td>
			...
			<tbody>
				<c:forEach items="${eb.list}" var="employee">
					<tr>
						<td>${employee.emp_id}
						<td>
						<td>${employee.emp_user}
						<td>
						<td>${employee.emp_name}
						<td>
						<td>${employee.emp_phone}
						<td>
						<td>${employee.emp_hire_date}
						<td>
						<td>${employee.emp_status_id}
						<td>
						<td>
							<button type="button" class="btn btn-success btn-xs"
								data-toggle="modal" data-target="#myModal1">权限修改</button> <!-- 模态窗 -->
...
>>>>>>> 712c1a0a5b929633c3629d3b36326b3b23e03260
											...
											<div class="row">
												<div class="col-xs-12">
													...
													<label class="checkbox-inline"> <input
														...
														添加用户 </label> <label class="checkbox-inline"> <input
														type="checkbox" id="inlineCheckbox2" value="option2">
														删除用户 </label> <label class="checkbox-inline"> <input
														type="checkbox" id="inlineCheckbox3" value="option3">
														状态修改 </label> <label class="checkbox-inline"> <input
														type="checkbox" id="inlineCheckbox3" value="option3">
														权限修改 </label>
												</div>
												<div class="col-xs-12">
													...
													<label class="checkbox-inline"> <input
														type="checkbox" id="inlineCheckbox1" value="option1">
														项目审核 </label> <label class="checkbox-inline"> <input
														type="checkbox" id="inlineCheckbox2" value="option2">
														财务审核 </label>
												</div>
												<div class="col-xs-12">
													...
													<label class="checkbox-inline"> <input
														type="checkbox" id="inlineCheckbox1" value="option1">
														用户认证 </label> <label class="checkbox-inline"> <input
														type="checkbox" id="inlineCheckbox1" value="option1">
														项目审核 </label> <label class="checkbox-inline"> <input
														type="checkbox" id="inlineCheckbox1" value="option1">
														财务审核 </label>
												...
												<div class="col-xs-12">
													...
													<label class="checkbox-inline"> <input
														type="checkbox" id="inlineCheckbox1" value="option1">
														捐款管理 </label> <label class="checkbox-inline"> <input
														type="checkbox" id="inlineCheckbox2" value="option2">
														支出管理 </label> <label class="checkbox-inline"> <input
														type="checkbox" id="inlineCheckbox3" value="option3">
														支出审核 </label>
												</div>
											</div>
				...
				<div>
					<a id="reducePage"
						href="emp_selectEmp.action?currentPage=${eb.currentPage<1?1:eb.currentPage-1}&pageSize=${eb.pageSize}
						&id=$">上一页</a>
					第${eb.currentPage}页/共${eb.allPage}页 <a id="addPage"
						href="emp_selectEmp.action?currentPage=${eb.currentPage>eb.allPage?eb.allPage:eb.currentPage+1}&pageSize=${eb.pageSize}">下一页</a>
				</div>
			<tbody>
		</table>
...
<<<<<<< HEAD
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/admin/jquery/jquery-2.1.3.min.js"></script>
	<script type="text/javascript"
