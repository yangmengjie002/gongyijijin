				...
				<div class="row">
					<div class="col-xs-5">
						...
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon1">项目名:</span> <input
								type="text" class="form-control" placeholder="请输入项目名称"
				...
				<div class="row">
					...
					<div class="col-xs-5">
						...
						<div class="input-group">
							...
							<label for="checkbox1" id="council_check"> 大型项目 </label> <span
								id="council_check_geren"> <input id="checkbox1"
								type="checkbox"> <label for="checkbox1"
								id="council_check"> 个人项目 </label> </span>
						</div>
					</div>
					<div class="col-xs-2">
